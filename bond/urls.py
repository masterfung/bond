...
urlpatterns = patterns('',
                       ...
                       url(r'^profile/(?P<interest_id>\w+)/delete/$', 'apps.profiles.views.delete_interest', name='delete_interest'),
                       ...
                       url(r'^meetup_all/$', 'apps.meetup.views.meetup_api_find_open_events', name='all_open_event'),
