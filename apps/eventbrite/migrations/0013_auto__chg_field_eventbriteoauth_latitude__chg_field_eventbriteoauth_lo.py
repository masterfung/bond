...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventbriteOAuth.latitude'
        db.alter_column(u'eventbrite_eventbriteoauth', 'latitude', self.gf('django.db.models.fields.FloatField')(max_length=40, null=True))

        # Changing field 'EventbriteOAuth.longitude'
        db.alter_column(u'eventbrite_eventbriteoauth', 'longitude', self.gf('django.db.models.fields.FloatField')(max_length=40, null=True))

    def backwards(self, orm):

        # Changing field 'EventbriteOAuth.latitude'
        db.alter_column(u'eventbrite_eventbriteoauth', 'latitude', self.gf('django.db.models.fields.FloatField')(max_length=15, null=True))

        # Changing field 'EventbriteOAuth.longitude'
        db.alter_column(u'eventbrite_eventbriteoauth', 'longitude', self.gf('django.db.models.fields.FloatField')(max_length=15, null=True))
    ...
    models = {
        ...
        u'eventbrite.eventbriteoauth': {
            ...
            'cost_display': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'country': ('django.db.models.fields.CharField', [], {'max_length': '35', 'null': 'True', 'blank': 'True'}),
            ...
            'ticket_free': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'venue': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        }
    }
