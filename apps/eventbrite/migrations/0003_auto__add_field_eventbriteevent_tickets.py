...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventbriteEvent.tickets'
        db.add_column(u'eventbrite_eventbriteevent', 'tickets',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventbriteEvent.tickets'
        db.delete_column(u'eventbrite_eventbriteevent', 'tickets')
