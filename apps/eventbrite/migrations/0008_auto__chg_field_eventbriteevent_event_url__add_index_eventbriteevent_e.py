...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventbriteEvent.event_url'
        db.alter_column(u'eventbrite_eventbriteevent', 'event_url', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
        # Adding index on 'EventbriteEvent', fields ['event_url']
        db.create_index(u'eventbrite_eventbriteevent', ['event_url'])


    def backwards(self, orm):
        # Removing index on 'EventbriteEvent', fields ['event_url']
        db.delete_index(u'eventbrite_eventbriteevent', ['event_url'])


        # Changing field 'EventbriteEvent.event_url'
        db.alter_column(u'eventbrite_eventbriteevent', 'event_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        u'eventbrite.eventbriteevent': {
            ...
            'event_url': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
