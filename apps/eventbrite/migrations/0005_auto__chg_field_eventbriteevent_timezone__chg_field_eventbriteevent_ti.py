...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventbriteEvent.timezone'
        db.alter_column(u'eventbrite_eventbriteevent', 'timezone', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'EventbriteEvent.timezone_offset'
        db.alter_column(u'eventbrite_eventbriteevent', 'timezone_offset', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'EventbriteEvent.timezone'
        db.alter_column(u'eventbrite_eventbriteevent', 'timezone', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'EventbriteEvent.timezone_offset'
        db.alter_column(u'eventbrite_eventbriteevent', 'timezone_offset', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))
