...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'eventbrite_eventbriteoauth', (
            ...
            ('event_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ...
            ('ticket_free', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('cost_display', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('category_name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
    ...
    models = {
        ...
        u'eventbrite.eventbriteoauth': {
            ...
            'ticket_free': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'venue': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        }
    }
