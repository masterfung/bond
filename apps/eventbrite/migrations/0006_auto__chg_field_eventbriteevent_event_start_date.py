...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventbriteEvent.event_start_date'
        db.alter_column(u'eventbrite_eventbriteevent', 'event_start_date', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'EventbriteEvent.event_start_date'
        db.alter_column(u'eventbrite_eventbriteevent', 'event_start_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
