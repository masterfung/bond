...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventbriteOAuth.postal_code'
        db.alter_column(u'eventbrite_eventbriteoauth', 'postal_code', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'EventbriteOAuth.city'
        db.alter_column(u'eventbrite_eventbriteoauth', 'city', self.gf('django.db.models.fields.CharField')(max_length=85, null=True))

        # Changing field 'EventbriteOAuth.country'
        db.alter_column(u'eventbrite_eventbriteoauth', 'country', self.gf('django.db.models.fields.CharField')(max_length=85, null=True))

    def backwards(self, orm):

        # Changing field 'EventbriteOAuth.postal_code'
        db.alter_column(u'eventbrite_eventbriteoauth', 'postal_code', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'EventbriteOAuth.city'
        db.alter_column(u'eventbrite_eventbriteoauth', 'city', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'EventbriteOAuth.country'
        db.alter_column(u'eventbrite_eventbriteoauth', 'country', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))
    ...
    models = {
        ...
        u'eventbrite.eventbriteoauth': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '85', 'null': 'True', 'blank': 'True'}),
            'cost': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'country': ('django.db.models.fields.CharField', [], {'max_length': '85', 'null': 'True', 'blank': 'True'}),
            ...
            'ticket_fee': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'venue': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        }
    }
