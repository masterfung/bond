...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventbriteOAuth.event_name'
        db.alter_column(u'eventbrite_eventbriteoauth', 'event_name', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'EventbriteOAuth.event_name'
        db.alter_column(u'eventbrite_eventbriteoauth', 'event_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
