...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventbriteOAuth.address'
        db.alter_column(u'eventbrite_eventbriteoauth', 'address', self.gf('django.db.models.fields.CharField')(max_length=260, null=True))

        # Changing field 'EventbriteOAuth.category_name'
        db.alter_column(u'eventbrite_eventbriteoauth', 'category_name', self.gf('django.db.models.fields.CharField')(max_length=260, null=True))

    def backwards(self, orm):

        # Changing field 'EventbriteOAuth.address'
        db.alter_column(u'eventbrite_eventbriteoauth', 'address', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'EventbriteOAuth.category_name'
        db.alter_column(u'eventbrite_eventbriteoauth', 'category_name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))
    ...
    models = {
        ...
        u'eventbrite.eventbriteoauth': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'max_length': '260', 'null': 'True', 'blank': 'True'}),
            'category_name': ('django.db.models.fields.CharField', [], {'max_length': '260', 'null': 'True', 'blank': 'True'}),
            ...
            'event_name': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
