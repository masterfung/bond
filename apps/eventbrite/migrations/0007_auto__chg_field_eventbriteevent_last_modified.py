...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventbriteEvent.last_modified'
        db.alter_column(u'eventbrite_eventbriteevent', 'last_modified', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

    def backwards(self, orm):

        # Changing field 'EventbriteEvent.last_modified'
        db.alter_column(u'eventbrite_eventbriteevent', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(null=True))
