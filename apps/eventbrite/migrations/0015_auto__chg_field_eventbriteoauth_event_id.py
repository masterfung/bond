...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventbriteOAuth.event_id'
        db.alter_column(u'eventbrite_eventbriteoauth', 'event_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'EventbriteOAuth.event_id'
        db.alter_column(u'eventbrite_eventbriteoauth', 'event_id', self.gf('django.db.models.fields.IntegerField')(max_length=15, null=True))
