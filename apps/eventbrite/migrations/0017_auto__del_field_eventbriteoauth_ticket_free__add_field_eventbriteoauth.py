...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventbriteOAuth.ticket_free'
        db.delete_column(u'eventbrite_eventbriteoauth', 'ticket_free')

        # Adding field 'EventbriteOAuth.ticket_fee'
        db.add_column(u'eventbrite_eventbriteoauth', 'ticket_fee',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EventbriteOAuth.ticket_free'
        db.add_column(u'eventbrite_eventbriteoauth', 'ticket_free',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EventbriteOAuth.ticket_fee'
        db.delete_column(u'eventbrite_eventbriteoauth', 'ticket_fee')
