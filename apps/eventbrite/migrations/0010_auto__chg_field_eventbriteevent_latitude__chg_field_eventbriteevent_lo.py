...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventbriteEvent.latitude'
        db.alter_column(u'eventbrite_eventbriteevent', 'latitude', self.gf('django.db.models.fields.FloatField')(max_length=15, null=True))

        # Changing field 'EventbriteEvent.longitude'
        db.alter_column(u'eventbrite_eventbriteevent', 'longitude', self.gf('django.db.models.fields.FloatField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'EventbriteEvent.latitude'
        db.alter_column(u'eventbrite_eventbriteevent', 'latitude', self.gf('django.db.models.fields.IntegerField')(max_length=15, null=True))

        # Changing field 'EventbriteEvent.longitude'
        db.alter_column(u'eventbrite_eventbriteevent', 'longitude', self.gf('django.db.models.fields.IntegerField')(max_length=15, null=True))
