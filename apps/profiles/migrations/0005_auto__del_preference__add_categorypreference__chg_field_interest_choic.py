...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CategoryPreference'
        db.create_table(u'profiles_categorypreference', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
        ))
        db.send_create_signal(u'profiles', ['CategoryPreference'])


        # Changing field 'Interest.choice'
        db.alter_column(u'profiles_interest', 'choice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.CategoryPreference']))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CategoryPreference'
        db.delete_table(u'profiles_categorypreference')


        # Changing field 'Interest.choice'
        db.alter_column(u'profiles_interest', 'choice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Preference']))
