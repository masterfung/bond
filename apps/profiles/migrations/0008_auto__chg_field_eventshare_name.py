...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventShare.name'
        db.alter_column(u'profiles_eventshare', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'EventShare.name'
        db.alter_column(u'profiles_eventshare', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
