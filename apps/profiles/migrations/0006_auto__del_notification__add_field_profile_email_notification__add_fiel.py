...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'profiles_profile', 'email_notification',
                      self.gf('django.db.models.fields.CharField')(default='Enrolled', max_length=25),
                      keep_default=False)

        # Adding field 'Profile.text_notification'
        db.add_column(u'profiles_profile', 'text_notification',
                      self.gf('django.db.models.fields.CharField')(default='Enrolled', max_length=25),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'profiles_profile', 'email_notification')

        # Deleting field 'Profile.text_notification'
        db.delete_column(u'profiles_profile', 'text_notification')
