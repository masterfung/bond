...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.fib'
        db.add_column(u'profiles_profile', 'fib',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.fib'
        db.delete_column(u'profiles_profile', 'fib')
    ...
    models = {
        ...
        u'profiles.profile': {
            ...
            'fib': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
