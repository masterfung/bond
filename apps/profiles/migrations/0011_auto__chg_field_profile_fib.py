...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.fib'
        db.alter_column(u'profiles_profile', 'fib', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Profile.fib'
        db.alter_column(u'profiles_profile', 'fib', self.gf('django.db.models.fields.IntegerField')(null=True))
