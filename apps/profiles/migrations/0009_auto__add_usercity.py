...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserCity'
        db.create_table(u'profiles_usercity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='usercity_profile', to=orm['profiles.Profile'])),
        ))
        db.send_create_signal(u'profiles', ['UserCity'])


    def backwards(self, orm):
        # Deleting model 'UserCity'
        db.delete_table(u'profiles_usercity')
