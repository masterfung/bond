...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.food_score'
        db.add_column(u'profiles_profile', 'food_score',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Profile.wellness_score'
        db.add_column(u'profiles_profile', 'wellness_score',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Profile.community_score'
        db.add_column(u'profiles_profile', 'community_score',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Profile.personal_score'
        db.add_column(u'profiles_profile', 'personal_score',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Profile.education_score'
        db.add_column(u'profiles_profile', 'education_score',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.food_score'
        db.delete_column(u'profiles_profile', 'food_score')

        # Deleting field 'Profile.wellness_score'
        db.delete_column(u'profiles_profile', 'wellness_score')

        # Deleting field 'Profile.community_score'
        db.delete_column(u'profiles_profile', 'community_score')

        # Deleting field 'Profile.personal_score'
        db.delete_column(u'profiles_profile', 'personal_score')

        # Deleting field 'Profile.education_score'
        db.delete_column(u'profiles_profile', 'education_score')
