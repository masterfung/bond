...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.zip'
        db.alter_column(u'meetup_event', 'zip', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Event.zip'
        db.alter_column(u'meetup_event', 'zip', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
