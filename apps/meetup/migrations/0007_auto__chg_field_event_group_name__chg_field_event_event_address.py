...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.group_name'
        db.alter_column(u'meetup_event', 'group_name', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'Event.event_address'
        db.alter_column(u'meetup_event', 'event_address', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

    def backwards(self, orm):

        # Changing field 'Event.group_name'
        db.alter_column(u'meetup_event', 'group_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Event.event_address'
        db.alter_column(u'meetup_event', 'event_address', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
