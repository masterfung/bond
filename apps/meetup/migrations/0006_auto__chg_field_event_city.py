...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'meetup_event', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

    def backwards(self, orm):

        # Changing field 'Event.city'
        db.alter_column(u'meetup_event', 'city', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
