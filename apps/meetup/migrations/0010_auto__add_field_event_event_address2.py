...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.event_address2'
        db.add_column(u'meetup_event', 'event_address2',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.event_address2'
        db.delete_column(u'meetup_event', 'event_address2')
