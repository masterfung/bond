...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.scrapy_event_url'
        db.add_column(u'meetup_event', 'scrapy_event_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.scrapy_event_url'
        db.delete_column(u'meetup_event', 'scrapy_event_url')
